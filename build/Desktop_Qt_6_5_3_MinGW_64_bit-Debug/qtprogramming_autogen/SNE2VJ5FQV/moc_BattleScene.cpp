...
Q_CONSTINIT static const qt_meta_stringdata_CLASSBattleSceneENDCLASS_t qt_meta_stringdata_CLASSBattleSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 14),  // "gameoverSignal"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 6),  // "winner"
        QT_MOC_LITERAL(35, 6),  // "update"
        QT_MOC_LITERAL(42, 15)   // "spawnRandomItem"
    },
    "BattleScene",
    "gameoverSignal",
    "",
...
void BattleScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gameoverSignal((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->update(); break;
        case 2: _t->spawnRandomItem(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BattleScene::*)(int );
            if (_t _q_method = &BattleScene::gameoverSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BattleScene::gameoverSignal(int _t1)
{
